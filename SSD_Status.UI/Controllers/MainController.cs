            ...
            { 
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    foreach (var line in File.ReadAllLines(openFileDialog.FileName).Skip(1))
                    {
                        ...
                        DateTime timestamp = DateTime.ParseExact(entries[0], "dd/MM/yyyy HH:mm:ss", CultureInfo.InvariantCulture);
                        ...
                        _viewModel.UsageStatsInfo.UsageValues.Add(new KeyValuePair<DateTime, double>(timestamp, writtenGb));
                    }
                }
            }
        }
